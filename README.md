...
Has been tested successfully on three ESP8266 and two Pro Micro boards (one server and two clients).
...
If this is not an option for you, just go to the "web" folder, edit the webpages/JavaScript files, and run the webconverter.py file in the main directory to update the files.
