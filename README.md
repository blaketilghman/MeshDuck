...
Known Issues:
<ul>
  <li> Larger files will not send over the mesh. Working scripts so far have been less than 2000 bytes. 1999 bytes is fine, but 2000 will not send over mesh. This could be a limitation of the PainlessMesh library. It is recommended to split larger payloads into a few smaller payloads <= 1500 bytes for best performance. 
</ul>
<br><hr>
