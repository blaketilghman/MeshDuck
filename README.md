...
If this is not an option for you, just go to the "web" folder, edit the webpages/JavaScript files, and run the .py file in the main directory to update the files.
